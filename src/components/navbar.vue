  ...
  >
    <div class="container">
      ...
      <a class="navbar-brand logo" href="/">
        ...
        <img src="@/assets/images/logo.png" alt class="logo-light" height="24" />
      </a>
      <button
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mx-auto navbar-center" id="mySidenav" v-scroll-spy-active>
          ...
          <li class="nav-item">
          <a href="javascript: void(0);" v-scroll-to="'#product'" class="nav-link">Our Product</a>
          </li>
          <li class="nav-item">
            <a href="javascript: void(0);" v-scroll-to="'#features'" class="nav-link" >Features</a>
          </li>
          <li class="nav-item">
            <a href="javascript: void(0);" v-scroll-to="'#client'" class="nav-link">Our Client</a>
          </li>
          <li class="nav-item">
            <a
